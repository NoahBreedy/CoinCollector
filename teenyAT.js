 ...
 */ 
const BitManip = require('./utils.js'); 
...
function TeenyAT(){
    ...
    this.swap_endian = (bin_data) => {
      var index = 0;
      for(var i = 0; i < bin_data.length-1; i+=2){
          this.ram[index] = {u:new BitManip.UINT16(parseInt("0x" + bin_data[i+1] + bin_data[i])),
                             s:new BitManip.INT16(parseInt("0x" +  bin_data[i+1] + bin_data[i]))};
          index++;
      }
    };
