...
*   
*   NOTE: You can write hex e.x. 0xBEEF but you cannot write binary e.x. 0b00000 
*   
*   NOTE: The [] and , are optional but you should still write them
*   as they make code easier to read (syntactic sugar)
*   
...
const registers_dict = {
    ...
    "r1":1,   //    stack pointer
    "r2":2,   //    register zero
    "r3":3,   //    General Purpose Registers rA --> rE
    "r4":4,   
    "r5":5,   
    "r6":6,   
    "r7":7,   
...
/* This probably definetly could be written a little better  */
...
function assemble(text){
    ...
    for(var label_resolver = 0; label_resolver < MAX_LABEL_RESOLVES; label_resolver++){
        ...
        for(loop_number = 0; loop_number < line_length; loop_number++){
                ...
                // The ugliest line ive ever written
